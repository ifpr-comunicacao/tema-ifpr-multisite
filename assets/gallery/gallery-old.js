...
window.addEventListener('load', function () {
    ...
    if (carItem.length > 0) {
        ...
        var container_end = document.querySelector('.carousel');
        container_end.innerHTML = '<ul class="carousel-inner ifpr_gallery">' +container_end.innerHTML+ '</ul>';

        //add prev and next gallery
        var $prevNext = document.querySelector('.carousel');
        ...
        $prevNext.insertAdjacentHTML( 'beforeend', html_prev_next );
